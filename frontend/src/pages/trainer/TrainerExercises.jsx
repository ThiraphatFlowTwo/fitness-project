...
function TrainerExercises() {
  ...
  // ── เช็คสิทธิ์ ────────────────────────────────────────────────
  const canEdit = (ex) => {
    if (ex.ownerRole === "admin") return false; // ห้ามแก้ของ admin
    if (!ex.created_by) return true; // ท่าเก่าที่ไม่มี created_by
    const createdById = ex.created_by?._id || ex.created_by;
    return createdById === currentUser.id; // เฉพาะเจ้าของ
  };
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-slate-50 border-b">
              <th className="px-6 py-4 text-left">ท่าฝึก</th>
              <th className="px-6 py-4 text-left">กลุ่มกล้ามเนื้อ</th>
        ...
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-xl overflow-hidden">
            <div className="bg-slate-50 px-8 py-6 border-b flex justify-between items-center">
              <h2 className="text-xl font-black">รายละเอียดท่าฝึก</h2>
            ...
            <div className="p-8 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="border rounded-xl p-4">
                  <p className="text-sm text-slate-500">กลุ่มกล้ามเนื้อ</p>
                  <p className="font-bold">{viewExercise.exercise_type}</p>
                </div>
                <div className="border rounded-xl p-4">
                  <p className="text-sm text-slate-500">อุปกรณ์</p>
                  <p className="font-bold">{viewExercise.equipment_type}</p>
                </div>
                <div className="border rounded-xl p-4">
                  <p className="text-sm text-slate-500">ประเภทการวัดผล</p>
                ...
                <div className="border rounded-xl p-4">
                  <p className="text-sm text-slate-500">สร้างโดย</p>
                  <p className="font-bold">
              ...
              <div className="border rounded-xl p-4">
                ...
                <p>{viewExercise.description || "ไม่มีรายละเอียด"}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-xl max-h-[90vh] overflow-y-auto">
            <div className="bg-slate-50 px-8 py-6 border-b flex justify-between items-center sticky top-0">
            ...
            <div className="p-8 space-y-5">
              ...
              {/* ประเภทการวัดผล */}
              <div>
                <label className="block mb-1 font-bold">ประเภทการวัดผล</label>
                <select
